...
MySQL - 5.6.16-log : Database - miaomore
*********************************************************************
*/
...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`miaomore` /*!40100 DEFAULT CHARACTER SET utf8 */;
...
CREATE TABLE `promo_bank_card` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=270 DEFAULT CHARSET=utf8 COMMENT='我的银行卡';
...
CREATE TABLE `promo_cashback_pay` (
  `id` char(32) NOT NULL COMMENT '主键：MD5(cashback_时间戳)',
...
CREATE TABLE `promo_detail` (
  ...
  `promocode_mobile` varchar(100) DEFAULT NULL COMMENT '电话',
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=5150 DEFAULT CHARSET=utf8 COMMENT='推广码使用明细表';
...
CREATE TABLE `promo_plan` (
  ...
  `create_time` bigint(20) NOT NULL COMMENT '创建日期',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=593 DEFAULT CHARSET=utf8 COMMENT='推广计划扩展表';
...
CREATE TABLE `promo_plan_code` (
  ...
  `update_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新日期',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1708 DEFAULT CHARSET=utf8 COMMENT='推广计划推广码关联表';
...
) ENGINE=InnoDB AUTO_INCREMENT=21 DEFAULT CHARSET=utf8 COMMENT='推广计划主表';
